...
if __name__ == '__main__':
    ...
    gobject.timeout_add(4000, info_sender.send_info, dict(text='How are you ?', location='bottom-left'))
    gobject.timeout_add(6000, info_sender.send_info, dict(text="I'm fine and you ?", location='top-right'))
    gobject.timeout_add(8000, info_sender.send_info, dict(text='Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', location='bottom-right', style='error'))
